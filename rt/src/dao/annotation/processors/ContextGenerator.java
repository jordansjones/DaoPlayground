...
@SupportedAnnotationTypes({"dao.annotation.Table"})
@SupportedSourceVersion(SourceVersion.RELEASE_6)
@SupportedOptions({"basePackage"})
public class ContextGenerator extends AbstractProcessor {
    ...
    public void init(final ProcessingEnvironment processingEnv) {
        ...
        final Map<String,String> options = processingEnv.getOptions().isEmpty() ? ImmutableMap.of("basePackage", "dao")
    ...
    public boolean process(final Set<? extends TypeElement> annotations, final RoundEnvironment roundEnv) {
        if (!roundEnv.processingOver()) {
            ...
            for (TypeElement typeElement : ElementFilter.typesIn(roundEnv.getElementsAnnotatedWith(Table.class))) {
                ...
                final Entity entity = new Entity(this.basePackage, typeElement);
                for (VariableElement variableElement : ElementFilter.fieldsIn(typeElement.getEnclosedElements())) {
                    if (variableElement.getAnnotation(Column.class) == null) continue;
    ...
    private void generateDataContext(final List<Entity> entities) {
        ...
        try {
            final JavaFileObject fileObject = filer.createSourceFile("dao.context.DataContext");
...
//    }
    ...
    private static void writeImportStatements(final Set<String> imports, final Writer writer) throws IOException {
    ...
    private static void writePackageStatement(final Entity entity, final Writer writer) throws IOException {
